...
if docker != '[Service]\n':
    with open('http-proxy.conf', 'w') as f:
        f.write(docker)

    dockerclient = docker_client_tpl % (proxy_info['http']['url'],
                                        proxy_info['https']['url'],
                                        no_proxy)
    with open('config.json', 'w') as f:
        f.write(dockerclient)
